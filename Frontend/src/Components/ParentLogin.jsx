...
import { useParentLoginMutation } from '../Slices/userApiSlice'; // Assuming you have the endpoint defined
...
const ParentLogin = () => {
  ...
  const [login, { isLoading }] = useParentLoginMutation();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/Parent'); // Navigate to the parent's dashboard
    } catch (err) {
    ...
    <section className="min-h-screen flex items-center justify-center">
      <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
        <div className="md:w-1/2 px-8 md:px-16">
          <h2 className="font-bold text-2xl text-[#002D74]">Parent Login</h2>
