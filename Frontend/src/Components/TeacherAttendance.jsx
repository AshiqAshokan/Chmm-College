...
import { useGetTeachersQuery, useMarkAttendanceMutation } from '../Slices/userApiSlice';
...
const StudentAttendance = () => {
  ...
  const { data: teacherData, isLoading, error } = useGetTeachersQuery();
