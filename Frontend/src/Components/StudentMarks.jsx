...
import { useGetStudentMarksQuery } from '../Slices/userApiSlice'; // Import your API slice

const  StudentMarks = () => {
  const { userInfo } = useSelector((state) => state.auth);
  const { data: marks, isLoading, isError } = useGetStudentMarksQuery(userInfo?._id); // Fetch marks data
