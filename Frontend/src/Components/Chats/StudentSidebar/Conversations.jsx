...
import {  useGetTeacherListQuery } from '../../../Slices/userApiSlice';
import avatar from "../../../assets/avatar.jpg"; 
import SearchInput from '../StudentSidebar/SearchInput'; 
...
const Conversations = ({ onSelectUser }) => { // Accept onSelectUser as a prop
  ...
  const { data: students, error, isLoading } =  useGetTeacherListQuery({ course });
