...
import Message from '../StudentMessages/Message';
import MessageInput from '../StudentMessages/MessageInput';
  ...
  return (
    <div className='md:min-w-full flex flex-col h-full'>
      <div className='flex-1 overflow-auto'>
        ...
        <Message receiverId={selectedUser._id} course={selectedUser.course} />
      </div>
      <MessageInput receiverId={selectedUser._id} userType={selectedUser.userType}  />
    </div>
  );
}
